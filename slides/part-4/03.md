...
echo "========================================"
fly -t ${target} set-pipeline --pipeline ${base}_${branch}_CI -c ci/pipeline.yml \
   --var "MAVEN_REPO=${MAVEN_REPO}" --var "SONAR=${SONAR}" -l credentials.yml
